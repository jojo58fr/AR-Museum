...
{
	public UserInterface UserInterfacePrefab;
	public OptionsMenu OptionsMenuPrefab;
    public IntroMenu IntroMenuPrefab;
    public AboutMenu AboutMenuPrefab;
    public CalibrationMenu CalibrationMenuPrefab;
    public VideoMenu VideoMenuPrefab;
    public QuizzMenu QuizzMenuPrefab;
    public ResultMenu ResultMenuPrefab;
